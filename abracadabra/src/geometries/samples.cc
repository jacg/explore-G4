...
G4VPhysicalVolume* phantom_in_cylinder(nema_phantom const& phantom, G4double length) {
  ...
  auto sensor_envelope = cylinder_lined_with_hamamatsus(length, phantom_radius*1.5);
