...
G4PVPlacement* nema_7_phantom::geometry() const {
  ...
  auto lung  = vacuum; //material("NEMA7_LUNG");
  auto air   = vacuum; //material("G4_AIR");
  auto water = vacuum; //material("G4_WATER"); // The radioactive source is floating around in water
